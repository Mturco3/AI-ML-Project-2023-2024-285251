...
After that, we focused on the categorical features, trying to understand how they are distributed and the most frequent value. The names of the columns are pretty self-explanatory:  
  ...
  - Gender: There is a slight female majority in the dataset.
  - Work or Leisure: Whether a customer is traveling for work reasons or not. There is an higher number of work travels than leisure travels.
...
<img src="images/ROC_Curves.png" width="1000" height="400"> <br>
